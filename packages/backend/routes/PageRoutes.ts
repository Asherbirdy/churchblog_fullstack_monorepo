...
router.patch('/set-to-online-scheduled/:id', authenticateUser, PageController.setToOnlineScheduled)
router.patch('/cancel-scheduled/:id', authenticateUser, PageController.cancelScheduled)
router.patch('/set-to-offline-scheduled/:id', authenticateUser, PageController.setToOfflineScheduled)
